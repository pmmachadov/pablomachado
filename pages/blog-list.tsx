...
const BlogListPage = () => {
    ...
    return (
        <div className={styles.container} style={{ color: themeStyle.color }}>
            <div className={styles.header}>
                <Link href="/" className={styles.backLink}>
                    ← Volver al inicio
                </Link>
                <h1 className={styles.title}>Todos los Artículos</h1>
                <p className={styles.subtitle}>Explorando tecnología, desarrollo y las últimas tendencias en IA</p>
            </div>
